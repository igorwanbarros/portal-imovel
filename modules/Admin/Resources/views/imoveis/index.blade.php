...
<div class="table-responsive">
    <div class="col-lg-12 col-xs-12 padding-bottom-2x text-right">
        <a href="{{ URL::to('admin/imoveis/cadastrar') }}" title="Cadastrar" class="btn btn-sm bg-red">
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr class="text-center clickable-row" data-url='{{ URL::to('admin/imoveis/' . $imovel->id . '/editar') }}'>
                ...
                <td>{{ $imovel->cidade }}</td>
                <td>
                    <a href="{{ URL::to('admin/imoveis/' . $imovel->id . '/editar') }}" title="Editar" class="btn btn-xs bg-green">
                        <i class="fa fa-edit fa-fw"></i>
                    </a>
                    <a href="{{ URL::to('admin/imoveis/' . $imovel->id . '/destroy') }}" title="Remover" class="btn btn-xs bg-red">
